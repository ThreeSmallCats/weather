<template>
    <div class='search-box'>
        <div class='back-and-inp'  >
            ...
            <div class='inp' @click="getFocus">
                <label for="inp" class='label iconfont' @click="getFocus">&#xe664;
                <input type="text" id="inp" @click="getFocus" v-on:input='toSearch(value)' v-model="value" placeholder="   搜索地名">
                </label>
            </div>
        </div>
